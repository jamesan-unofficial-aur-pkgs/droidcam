...
md5sums=('8f4bf4470fb822f581a30e5142fb078a'
         '4786533e9be40305642543fe49b9b0ce'
...
package() {
  ...
  install -Dm644 "../../$pkgname.modprobe.conf"     "$pkgdir/usr/lib/modprobe.d/$pkgname.conf"
